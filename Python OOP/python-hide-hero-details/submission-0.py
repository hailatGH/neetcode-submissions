class SuperHero:
    ...
    def set_health(self, new_health):
        if new_health < 0 or new_health > 100:
            print(f"You can't set the health to {'less than 0' if new_health < 0 else 'more than 100'}")
        else:
    ...
    def set_power_level(self, new_power_level):
        if new_power_level < 1 or new_power_level > 10:
            print(f"You can't set the power level to {'less than 1' if new_power_level < 1 else 'more than 10'}")
        else:
